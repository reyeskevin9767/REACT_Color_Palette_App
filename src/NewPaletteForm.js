...
import DraggableColorLst from "./DraggableColorList";
        ...
        return (
          <div className={classes.root}>
            ...
            >
              ...
              <Button variant="contained" className={classes.button} color="primary" disabled={paletteIsFull} onClick={this.addRandomColor}>Random Color</Button>                  
              </div>
